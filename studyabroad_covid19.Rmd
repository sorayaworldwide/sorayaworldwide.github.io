---
title: "Study Abroad and Covid Sentiment Analysis"
...
I analyzed Twitter data to gauge the sentiment surrounding studying abroad given worldwide travel restrictions due to the virus.  

Many universities are cautiously optimistic -BUT- there is unequal distribution of the vaccine worldwide and regional pockets of increased cases  

I was curious about the outlook on this activity in the Twittersphere.

For more details on the CDC's guidance for IHE in relation to international travel or study abroad, visit:   <https://www.cdc.gov/coronavirus/2019-ncov/community/student-foreign-travel.html>
...
## Vader
Like others mentioned, Vader is pretty great for senitment analysis since you don't need to tokenize text!
...
## Sample tweets by sentiment (positive)- Vader

```{r}
tweet_embed("https://twitter.com/VISIT_Insurance/status/1367669706174455808?s=20")  
tweet_embed("https://twitter.com/ThamesLanka/status/1367393179884871680?s=20")
```
## Sample tweets by sentiment (negative) - Vader
```{r}
tweet_embed("https://twitter.com/bertholdts/status/1367483846044876807?s=20")  
tweet_embed("https://twitter.com/raplineugh/status/1367768417848025088?s=20")
```
